    ...
    <div>
      <div className="grid grid-cols-1 gap-5 p-5">
        ...
        <div>
          ...
          <p className="text-sm mt-5 px-5">ourney through the stunning landscapes of Switzerland, where snow-capped peaks and serene lakes offer unforgettable experiences.</p>
        </div>
        <div>
          <Image
            src={"/norway.jpg"}
